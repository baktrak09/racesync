...
# ✅ Debugging Output (AFTER DEFINING VARIABLES)
...
print(f"SHOPIFY_STORE_URL: {SHOPIFY_STORE_URL}")  # Now it's properly defined!
...
class User(db.Model):
    ...
    name = db.Column(db.String(100), nullable=False)  # Make sure 'name' exists
...
from models import db, User  # Ensure your database model is imported
...
def register():
    ...
    return render_template('home/register.html')  # Ensure the correct path
